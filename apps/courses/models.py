...
class Course(models.Model):
    ...
    degree = models.CharField(choices=(("cj", "初级"),("zj", "中级"),("gj", "高级")), max_length=12, verbose_name=u"难度")
...
class Lesson(models.Model):
    course = models.ForeignKey(Course, verbose_name=u"课程")  # 一个课程对应多个章节
...
class Video(models.Model):
    lesson = models.ForeignKey(Lesson, verbose_name=u"章节")  # 一个章节对应多个视频  指向lesson的外键
    name = models.CharField(max_length=100, verbose_name=u"视频名")
    url = models.CharField(max_length=200, verbose_name=u"访问地址", default="")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
    lesson_times = models.IntegerField(default=0, verbose_name=u"学习时长(分钟数)")
...
class CourseResource(models.Model):
    course = models.ForeignKey(Course, verbose_name=u"课程")  # 一个课程对应多个资源 指向course的外键
    name = models.CharField(max_length=100, verbose_name=u"名称")
    download = models.FileField(upload_to="course/resource/%Y/%m", verbose_name="资源文件", max_length=100)  # 后台管理系统直接生成上按钮
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
