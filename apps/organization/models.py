...
class CourseOrg(models.Model):
    ...
    category = models.CharField(default="pxjg", verbose_name=u"机构类别", max_length=20, choices=(('pxjg', u"培训机构"),('gx', u"高校" ),('gr', u"个人" )))
...
class Teacher(models.Model):
    org = models.ForeignKey(CourseOrg, verbose_name=u"所属机构")  # 指向机构的外键 一个机构对应多个老师
