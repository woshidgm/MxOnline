...
class UserAsk(models.Model):
    ...
    course_name = models.CharField(max_length=11, verbose_name=u"课程名")
...
class CourseComment(models.Model):
    ...
    comments = models.CharField(max_length=200, verbose_name=u"课程")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
...
class UserMessage(models.Model):
    user = models.IntegerField(default=0, verbose_name=u"接受用户")  # user为0 表示所有用户，否则为具体用户id
